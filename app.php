            ...
            handler: async function (response) {
                ...
                const emailPayload = {
                    ...
                    orderDetails: productsToBuy.map(product =>
                        `${product.Route} - Arrival -Station: ${product.Arrival} ,Departure-Station : ${product.Departure} * ${product.quantity}`
                    ...
                    {productsToBuy.map((item) => (
                        <li key={item._id}>
                            <div className="ticket-details">
                                ...
                                <p><strong>Arrival Station:</strong> {item.Arrival}</p>
                                <p><strong>Departure Station:</strong> {item.Departure}</p>
